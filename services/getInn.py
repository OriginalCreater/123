...
def get_id_affel_mail(mail : str, token : str) -> [str] :
    url = "https://gateway.cdek.ru/contragent/web/contragent/search/byFilters"
    ...
    "offset": 0,
    "limit": 100,
    "fields": [{"field": "email", "value": f'{mail}', "values": None}],
    "columns": [
        "id",
        "countryName",
        "cityName",
    ...
    inn = [item['inn'] for item in response.json()['items']]
    return inn
def get_id_affel_site(site : str, token : str) -> [str] :
    url = "https://gateway.cdek.ru/contragent/web/contragent/search/byFilters"
    ...
    "offset": 0,
    "limit": 100,
    "fields": [{"field": "site", "value": f'{site}', "values": None}],
    "columns": [
        "id",
        "countryName",
        "cityName",
    ...
    inn = [item['inn'] for item in response.json()['items']]
    return inn
def get_id_affel_name(name : str, token : str) -> [str] :
    url = "https://gateway.cdek.ru/contragent/web/contragent/search/byFilters"
    ...
    "offset": 0,
    "limit": 100,
    "fields": [{"field": "contact", "value": f'{name}', "values": None}],
    "columns": [
        "id",
        "countryName",
        "cityName",
